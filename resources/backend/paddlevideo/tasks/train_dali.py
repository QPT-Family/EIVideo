...
from resources.backend.paddlevideo.utils import (AverageMeter, build_record, log_batch, log_epoch,
                               save, load, mkdir)
from resources.backend.paddlevideo.loader import TSN_Dali_loader, get_input_data
"""
...
def train_dali(cfg, weights=None, parallel=True):
    ...
    # 2. Construct dali batch_sampler
