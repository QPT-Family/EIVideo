...
from resources.backend.paddlevideo.utils.manet_utils import kaiming_normal_
    ...
    def _init_weight(self):
        for m in self.sublayers():
            if isinstance(m, nn.Conv2D):
                ...
                from resources.backend.paddlevideo.utils.manet_utils import fill_
                fill_(m.weight, 1)
                from resources.backend.paddlevideo.utils.manet_utils import zero_
                zero_(m.bias)
