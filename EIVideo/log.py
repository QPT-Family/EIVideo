...
__all__ = ["Logging", "change_none_color", "clean_stout", "TProgressBar"]

# 创建一个logger
logger = logging.getLogger("EIVideo_logger")
...
f_handler = logging.FileHandler('./EIVideo.log', "w", encoding="utf-8")
