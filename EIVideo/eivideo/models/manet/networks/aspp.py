...
from ....utils.manet import kaiming_normal_
    ...
    def _init_weight(self):
        for m in self.sublayers():
            if isinstance(m, nn.Conv2D):
                ...
                from EIVideo.eivideo.utils.manet.manet_utils import fill_
                fill_(m.weight, 1)
                from EIVideo.eivideo.utils.manet.manet_utils import zero_
                zero_(m.bias)
