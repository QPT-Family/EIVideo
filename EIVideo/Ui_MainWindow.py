...
import os
from api import load_video, json2frame
from member import m
from collections import OrderedDict
from png2json import png2json
...
class Ui_MainWindow(object):
    ...
    def infer(self):
        ...
        png2json(m.image_path, self.sliderframenum, 'test_data.json')
        m.json_path = "test_data.json"
        print('inferok1')
        submit_frames = []
